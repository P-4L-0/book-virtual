<footer class="bg-red-200 dark:bg-gray-800">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
            ...
            <div class="mb-6 md:mb-0">
                <a href="/" class="flex items-center">
                    <span
                        class="self-center text-lg sm:text-xl lg:text-2xl font-semibold whitespace-nowrap dark:text-white ml-2">Virtual
                        Books</span>
                </a>
            </div>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <span class="text-xs sm:text-sm text-gray-700 dark:text-gray-400 text-center sm:text-left">©Virtual Books™.
