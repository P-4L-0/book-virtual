...
<body class="w-full h-full font-sans bg-[#f3f4f6] text-gray-800">
    ...
    <section class="w-full py-16 px-6 md:px-16 bg-gray-50 text-gray-800 rounded-xl shadow-xl max-w-7xl mx-auto mb-16 mt-24">
        <div class="flex flex-col lg:flex-row gap-8 items-center justify-between">
            ...
            <div class="lg:w-1/2 flex justify-center mt-8 lg:mt-0">
                <img src="<?php echo e(asset('img/acercaDe.png')); ?>" alt="Gestión de libros" class="max-w-md w-full rounded-xl shadow-lg">
            </div>
        </div>
    </section>
    ...
    <section class="w-full py-16 px-6 lg:px-20 bg-white rounded-xl shadow-lg mt-16 max-w-7xl mx-auto mb-16">
        <div class="flex flex-col lg:flex-row gap-8 items-center justify-between">
            ...
            <div class="lg:w-1/3 flex justify-center">
                <img src="<?php echo e(asset('img/libro.png')); ?>" alt="Libro" class="w-64 h-auto rounded-xl shadow-lg">
            </div>
    ...
    <section class="w-full py-16 px-6 lg:px-20 bg-gray-50 text-gray-800 rounded-xl shadow-lg mt-16 max-w-7xl mx-auto mb-16">
        <div class="flex flex-col lg:flex-row-reverse gap-8 items-center justify-between">
            ...
            <!-- Imagen -->
            <div class="lg:w-1/2 flex justify-center mt-8 lg:mt-0">
                <img src="<?php echo e(asset('img/leyendo.jpg')); ?>" alt="Niño leyendo" class="w-full max-w-md h-auto rounded-xl shadow-lg">
            </div>
        </div>
    </section>
