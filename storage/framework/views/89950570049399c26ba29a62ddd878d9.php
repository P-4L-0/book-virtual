<header class="w-full h-20 flex items-center justify-between px-6 bg-gradient-to-r from-red-300 via-red-200 to-red-100 shadow-md fixed top-0 left-0 z-50 backdrop-blur-md bg-opacity-70 transition-all ease-in-out duration-300">
    ...
    <div class="flex items-center space-x-6">
        <img src="<?php echo e(asset('img/book.png')); ?>" alt="Logo" class="w-12 h-12 transition-all duration-300 ease-in-out transform hover:rotate-12 hover:scale-110" />
...
<?php /**PATH C:\xampp\htdocs\book-virtual\resources\views/templates/header.blade.php ENDPATH**/ ?>