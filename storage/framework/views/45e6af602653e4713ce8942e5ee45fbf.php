                        ...
                        <?php $__currentLoopData = $libros; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $libro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div
                                ...
                                <div class="p-6">
                                    ...
                                    <p class="text-gray-600"><?php echo e($libro->autor->nombre ?? 'Sin autor'); ?></p>
                                ...
                                <div class="flex justify-end items-center p-4 border-t border-gray-100">
                                    <img class="h-6 w-6 mr-4 cursor-pointer" src="<?php echo e(asset('img/x.png')); ?>" alt="Eliminar" />
                                    <img class="h-6 w-6 cursor-pointer" src="<?php echo e(asset('img/heart.png')); ?>" alt="Favorito" />
                                </div>
                            </div>
