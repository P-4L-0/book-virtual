...
<body class="bg-gradient-to-b from-white to-red-50 text-gray-800 font-sans">
    ...
    <section class="w-full py-24 bg-gradient-to-r from-red-100 via-white to-red-100">
        <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between px-6 gap-12">
            ...
            <div class="lg:w-1/2">
                <img src="<?php echo e(asset('img/index.png')); ?>" alt="Gestión de libros" class="w-full max-w-md mx-auto rounded-xl shadow-2xl" />
            </div>
        </div>
    </section>
    ...
    <section class="w-full py-20 bg-gray-50">
        <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between px-6 gap-12">
            <div class="lg:w-1/2">
                <img src="<?php echo e(asset('img/leer.png')); ?>" alt="Lectura" class="w-52 lg:w-64 mx-auto lg:ml-auto" />
            </div>
            <div class="lg:w-1/2">
                ...
                <div class="bg-white p-6 rounded-xl shadow-xl">
                    ...
                    <ul class="space-y-5 text-gray-600">
                        <li class="flex items-center">
                            <img src="<?php echo e(asset('img/libros.png')); ?>" class="w-7 h-7 mr-3" />
                            Registro detallado de cada libro en tu colección.
                        </li>
                        <li class="flex items-center">
                            <img src="<?php echo e(asset('img/retroalimentacion.png')); ?>" class="w-7 h-7 mr-3" />
                            Clasificación flexible y personalizada de tu biblioteca.
                        </li>
                        <li class="flex items-center">
                            <img src="<?php echo e(asset('img/publicidad-online.png')); ?>" class="w-7 h-7 mr-3" />
