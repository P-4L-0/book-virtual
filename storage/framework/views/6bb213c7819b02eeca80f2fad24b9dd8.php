...
<nav
    ...
    <div class="sidebar flex flex-col flex-grow items-center py-6">
        ...
        <!-- Logo con sombra -->
        <div class="mt-4 w-40">
            <img src="<?php echo e(asset('img/VirtualBooks.png')); ?>" alt="logo.png">
        </div>
        ...
        <ul class="flex flex-col w-full mt-8">
            <li>
                <a href="/home"
                    ...
                    <img class="h-6 w-6 mr-3" src="<?php echo e(asset('svg/door.svg')); ?>" alt="Inicio" />
            ...
            <li>
                <a href="/mislibros"
                    class="flex items-center px-6 py-3 rounded-xl transition-all duration-300 hover:bg-red-200 hover:shadow-md hover:scale-105 transform focus:outline-none focus:ring-2 focus:ring-gray-500 active:bg-gray-300 active:font-semibold">
                    <img class="h-6 w-6 mr-3" src="<?php echo e(asset('svg/bookmark.svg')); ?>" alt="Mis Libros" />
            ...
            <li>
                <a href="/agregar"
                    class="flex items-center px-6 py-3 rounded-xl transition-all duration-300 hover:bg-red-200 hover:shadow-md hover:scale-105 transform focus:outline-none focus:ring-2 focus:ring-gray-500 active:bg-gray-300 active:font-semibold">
                    <img class="h-6 w-6 mr-3" src="<?php echo e(asset('svg/square-plus.svg')); ?>" alt="Agregar" />
            ...
            <li>
                <a href="/autores"
                    class="flex items-center px-6 py-3 rounded-xl transition-all duration-300 hover:bg-red-200 hover:shadow-md hover:scale-105 transform focus:outline-none focus:ring-2 focus:ring-gray-500 active:bg-gray-300 active:font-semibold">
                    <img class="h-6 w-6 mr-3" src="<?php echo e(asset('svg/id.svg')); ?>" alt="Autores" />
            ...
            <li>
                <a href="/categorias"
                    class="flex items-center px-6 py-3 rounded-xl transition-all duration-300 hover:bg-red-200 hover:shadow-md hover:scale-105 transform focus:outline-none focus:ring-2 focus:ring-gray-500 active:bg-gray-300 active:font-semibold">
                    <img class="h-6 w-6 mr-3" src="<?php echo e(asset('svg/category-2.svg')); ?>" alt="Información" />
            ...
            <li>
                <!--<a href="../views/.php"
                    class="flex items-center px-6 py-3 rounded-xl transition-all duration-300 hover:bg-red-200 hover:shadow-md hover:scale-105 transform focus:outline-none focus:ring-2 focus:ring-gray-500 active:bg-gray-300 active:font-semibold">
                    <img class="h-6 w-6 mr-3" src="<?php echo e(asset('svg/user.svg')); ?>" alt="Perfil" />
...
</nav><?php /**PATH C:\xampp\htdocs\book-virtual\resources\views/templates/menu.blade.php ENDPATH**/ ?>