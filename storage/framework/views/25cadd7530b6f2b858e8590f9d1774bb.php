  ...
  <div class="w-full h-screen p-2 flex flex-col bg-white lg:flex-row">
    ...
    <div class="hidden lg:block bg-red-500 w-2/5 rounded-xl p-11 order-1 relative">
      ...
      <div class="w-full h-full relative">
        <img src="<?php echo e(asset('img/books.jpg')); ?>" alt="doctor_svg" class="w-full h-full object-cover rounded-xl" />
      </div>
    </div>
  </div>
</body>

</html><?php /**PATH C:\xampp\htdocs\book-virtual\resources\views/Registro.blade.php ENDPATH**/ ?>