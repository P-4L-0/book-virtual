  ...
  <div class="mx-auto w-full max-w-screen-xl px-6">
    <div class="md:flex md:justify-between">
      ...
      <div class="grid grid-cols-2 gap-10 sm:grid-cols-3">
        <!-- Recursos -->
        <div>
          <h2 class="mb-4 text-sm font-semibold uppercase text-white">Recursos</h2>
          <ul class="space-y-2 text-gray-400">
            <li><a href="/libros" class="hover:text-white">Libros</a></li>
            <li><a href="/categorias" class="hover:text-white">Categorías</a></li>
            <li><a href="/autores" class="hover:text-white">Autores</a></li>
          </ul>
        </div>

        <!-- Sobre Nosotros -->
        <div>
          <h2 class="mb-4 text-sm font-semibold uppercase text-white">Sobre Nosotros</h2>
          <ul class="space-y-2 text-gray-400">
            <li><a href="/about" class="hover:text-white">¿Quiénes somos?</a></li>
            <li><a href="https://github.com/tu-usuario/virtual-books" class="hover:text-white">GitHub</a></li>
          </ul>
        </div>
    ...
    <div class="mt-12 text-center text-sm text-gray-500 border-t border-gray-700 pt-6">
      © Virtual Books™. Todos los derechos reservados.
    </div>
  </div>
</footer>
<?php /**PATH C:\xampp\htdocs\book-virtual\resources\views/templates/footer.blade.php ENDPATH**/ ?>