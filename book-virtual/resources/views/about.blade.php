    ...
    <div class="flex flex-col lg:flex-row w-full py-8 md:pl-16 px-5 lg:pt-16 bg-[#fafafa]">
        ...
        <div class="flex flex-col w-full lg:w-1/2 mx-auto items-center md:justify-center lg:text-left text-center">
            ...
            <ul class="text-start items-center text-sm pb-1 pl-1 lg:pl-24">
                <li class="text-sm md:text-base lg:text-2xl lg:font-semibold text-red-300 list-disc">Registra y organiza tus libros adquiridos fácilmente.</li>
                <li class="text-sm md:text-base lg:text-2xl lg:font-semibold text-red-300 list-disc">Añade detalles de los autores de cada libro.</li>
                <li class="text-sm md:text-base lg:text-2xl lg:font-semibold text-red-300 list-disc">Clasifica tu colección por categorías personalizadas.</li>
                <li class="text-sm md:text-base lg:text-2xl lg:font-semibold text-red-300 list-disc">Crea y gestiona una lista de deseos para futuras compras.</li>
                <li class="text-sm md:text-base lg:text-2xl lg:font-semibold text-red-300 list-disc">Acceso desde cualquier dispositivo para una experiencia fluida.</li>
            </ul>
        </div>
        ...
        <div class="flex flex-col lg:text-center lg:items-center">
            ...
            <div class="flex mx-8">
                <p class="text-base leading-loose">
                    Únete a nuestra plataforma y disfruta de una experiencia de organización única, con acceso para registrar libros, detalles de autores y gestionar tus futuras compras.
                </p>
            </div>
        </div>
            ...
            <div class="w-full lg:w-1/3 p-4">
                <div class="bg-red-50 pt-5 h-full rounded-xl shadow-xl">
                    ...
                    <div class="text-container overflow-hidden">
                        ...
                        <a href="#" onclick="toggleText('text1')" class="text-red-400 hover:underline block p-4">Leer más</a>
                    </div>
                </div>
            </div>
            ...
            <div class="w-full lg:w-1/3 p-4">
                <div class="border pt-5 h-full rounded-xl shadow-xl">
                    ...
                    <div class="text-container overflow-hidden">
                        ...
                        <a href="#" onclick="toggleText('text2')" class="text-red-400 hover:underline block p-4">Leer más</a>
                    </div>
                </div>
            </div>
            ...
            <div class="w-full lg:w-1/3 p-4">
                <div class="bg-red-50 pt-5 h-full rounded-xl shadow-xl">
                    ...
                    <div class="text-container overflow-hidden">
                        ...
                        <a href="#" onclick="toggleText('text3')" class="text-red-400 hover:underline block p-4">Leer más</a>
                    </div>
                </div>
            </div>
        </div>
