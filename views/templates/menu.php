...
<nav class="hidden lg:flex fixed top-0 left-0 bottom-0 w-64 bg-gradient-to-b from-gray-100 to-gray-300 text-gray-700 shadow-lg px-5">
    <div class="sidebar flex flex-col flex-grow items-center py-6">
        ...
        <div class="mt-auto w-full">
            <a href="" 
               class="flex items-center p-3 rounded-xl bg-red-500 text-white hover:bg-red-600 hover:shadow-xl hover:scale-105 transition-all duration-300 transform focus:outline-none focus:ring-2 focus:ring-red-500 active:bg-red-700 active:font-semibold">
